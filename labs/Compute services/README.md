...
<ol>Launched a web server with termination protection enabled</ol>

<ol>Monitored my EC2 instance</ol>

<ol>Modified the security group that my web server is using to allow HTTP access</ol>

<ol>Resized my Amazon EC2 instance to scale</ol>

<ol>Tested termination protection</ol>

<ol>Terminated my EC2 instance</ol>

<b><em>TASK1- Launching my EC2 instance</em></b>
...
<p>In the left navigation pane i click instances, there are no instances running therefore i launch an instance by clicking "LAUNCH INSTANCES" in orange</p>
...
<b><em>TASK 2- Monitor my instance</em></b>
...
<b><em>TASK 3- Updating security group and access the web server</em></b>
...
<b><em>TASK 4- Resizing my EC2 instance</em></b>
...
<b><em>TASK 5- Test Termination protection</em><b>
